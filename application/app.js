...
const regions = {
  ...
  region2: "Region II",
  region3: "Region III",
  region4a: "Region IV-A / IV-B",
  region4b: "Region IV-A / IV-B",
  region5: "Region V",
  region6: "Region VI",
  region7: "Region VII",
  region8: "Region VIII",
...
function submitApplication() {
  ...
  alert(
    "Application submitted successfully!\n\nThank you for applying for the Civil Service Examination. You will receive a confirmation email shortly.",
  );
